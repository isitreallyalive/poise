...
pub fn modal(input: syn::DeriveInput) -> Result<TokenStream, darling::Error> {
    ...
    for field in fields {
        ...
        parsers.push(quote::quote! {
            #field_ident: bert_core::__internal::poise::find_modal_text(&mut data, stringify!(#field_ident)) #ok_or,
        });
    }
    ...
    Ok(quote::quote! { const _: () = {
        use bert_core::__internal::poise::serenity_prelude as serenity;
        impl #impl_generics bert_core::__internal::poise::Modal for #struct_ident #ty_generics #where_clause {
