...
pub fn choice_parameter(input: syn::DeriveInput) -> Result<TokenStream, darling::Error> {
    ...
    Ok(quote::quote! {
        impl bert_core::__internal::poise::ChoiceParameter for #enum_ident {
            fn list() -> Vec<bert_core::__internal::poise::CommandParameterChoice> {
                vec![ #( bert_core::__internal::poise::CommandParameterChoice {
                    __non_exhaustive: (),
